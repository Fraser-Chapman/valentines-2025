...
export const theme: CustomThemeConfig = {
    ...
    properties: {
        ...
        // surface | #f47bea
        "--color-surface-50": "253 235 252", // #fdebfc
        "--color-surface-100": "253 229 251", // #fde5fb
        "--color-surface-200": "252 222 250", // #fcdefa
        "--color-surface-300": "251 202 247", // #fbcaf7
        "--color-surface-400": "247 163 240", // #f7a3f0
        "--color-surface-500": "244 123 234", // #f47bea
        "--color-surface-600": "220 111 211", // #dc6fd3
        "--color-surface-700": "183 92 176", // #b75cb0
        "--color-surface-800": "146 74 140", // #924a8c
        "--color-surface-900": "220 111 211", // #f47bea
        // "--color-surface-900": "244 123 234", // #f47bea
        // "--color-surface-900": "120 60 115", // #783c73
